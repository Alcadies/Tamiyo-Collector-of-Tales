...
function spoilerCleaner(message) {
    /*if ((lowmessage.includes("/2xm/") || (message.embeds[0] != undefined && message.embeds[0].description != undefined && message.embeds[0].description.includes("(2XM ")) || lowmessage.includes("/jmp/") || (message.embeds[0] != undefined && message.embeds[0].description != undefined && message.embeds[0].description.includes("(JMP "))) && message.channel.id != "641920724856078336" && message.channel.id != "298465947319140353" && message.channel.id != "720436488247967754") {
        message.delete();
